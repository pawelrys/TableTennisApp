        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(id == -1){
                    ...
                    if(nr_stolu == 0){
                        Intent intent = new Intent(refereeLoginPage.this, mainRefereeInterfacePage.class);
                        startActivity(intent);
                    }
                    else{
                        Intent intent = new Intent(refereeLoginPage.this, countingRefereeInterfacePage.class);
                        startActivity(intent);
                    }
                }
            }
